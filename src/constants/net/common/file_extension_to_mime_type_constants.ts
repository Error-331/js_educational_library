...
const FILE_EXTENSION_TO_MIME_TYPE: FileExtensionToMimeTypeRecords = {
    ...
    'midi': MIME_TYPE_MIDI,
    'mjs': MIME_TYPE_MJS,
    'mkv': MIME_TYPE_MATROSKA,
    'mk3d': MIME_TYPE_MATROSKA,
    'mka': MIME_TYPE_MATROSKA,
    'mks': MIME_TYPE_MATROSKA,
    'mod': MIME_TYPE_MOD,
    'mov': MIME_TYPE_QUICKTIME,
    'mts': MIME_TYPE_M2TS,
    'mp3': MIME_TYPE_MP3,
    'mp4': MIME_TYPE_MP4,
    'mpe': MIME_TYPE_MPEG,
    ...
    'mpeg4': MIME_TYPE_MP4,
    'mpg': {
        [META_MIME_TYPE_VIDEO]: MIME_TYPE_MP4,
        [META_MIME_TYPE_AUDIO]: MIME_TYPE_MP3,
    },
    'mpkg': MIME_TYPE_MPKG,
    'nsv': MIME_TYPE_NSV,
    'odp': MIME_TYPE_ODP,
    ...
    'webp': MIME_TYPE_WEBP,
    'wma': MIME_TYPE_ASF[META_MIME_TYPE_AUDIO],
    'wmv': MIME_TYPE_ASF[META_MIME_TYPE_VIDEO],
    'woff': MIME_TYPE_WOFF,
