...
// internal imports
import GraphVertexAdjacencyLinkedListClass from './adjacency_list/linked/code/graph_vertex_adjacency_linked_list_class.js';

// implementation
class GraphAdjacencyMatrixClass {
    #vertexRows = new Map();
    ...
    initByAdjacencyList(adjacencyList) {
        for(let rowIdx = 0; rowIdx < adjacencyList.length; rowIdx++) {
            ...
            for (const currentElement of currentListRow) {
                prevVertex = this.#addVertexData(currentRow, currentElement);
            }
        }
    }
...
// exports
export default GraphAdjacencyMatrixClass;
