...
// implementation
abstract class AbstractClientRequestFacade<ResponseDataType> extends AbstractBaseRequestFacade<ResponseDataType> {
...
// exports
export default AbstractClientRequestFacade;