...
} from './../../../../src/utils/testing/data_structures/tree/general_tree/general_tree_node_class_test_utils.js';

import GeneralTree from './../../../../src/data_structures/tree/general_tree/general_tree_class.js';
import GeneralTreeNode from './../../../../src/data_structures/tree/general_tree/general_tree_node_class.js';

// implementation
test('GeneralTreeNode tests...', async (t) => {
    await t.test('Instance creation tests...', async (t) => {
        await t.test('Should create a GeneralTreeNode - case 1', () => {
            ...
            try {
                node = new GeneralTreeNode(tree, null, null,null, data);
            } catch (error) {
        ...
        await t.test('Should create a GeneralTreeNode - case 2', () => {
            let tree = new GeneralTree();
            let node = null;
        ...
        await t.test('Should create a GeneralTreeNode - case 3', () => {
            let tree = new GeneralTree();
            ...
            try {
                parentNode = new GeneralTreeNode(tree, null, null,null, data1);
                childNode = new GeneralTreeNode(tree, parentNode, null, null, data2);
            } catch (error) {
                assert.fail(`Cannot create a node; ${error.message}`);
            }
    ...
    await t.test('Data change tests...', async (t) => {
        await t.test('Should change node data successfully - case 1', () => {
            ...
            const node = new GeneralTreeNode(tree, null, null, null, data1);
    ...
    await t.test('"getChildAt" getter tests...', async (t) => {
        await t.test('Should correctly get child node at specific index - case 1', () => {
            ...
            const tree = new GeneralTree();
            const parentNode = new GeneralTreeNode(tree, null, null, null, data);
    ...
    await t.test('"isLeaf" method tests...', async (t) => {
        await t.test('Should correctly determine whether specific node is leaf or not - case 1', () => {
            ...
            const tree = new GeneralTree();
            const parentNode = new GeneralTreeNode(tree, null, null,null, data1);
        ...
        await t.test('Should correctly determine whether specific node is leaf or not - case 2', () => {
            ...
            const childNode = new GeneralTreeNode(tree, parentNode, null, null, data2);
            assert.strictEqual(parentNode.isLeaf, true);
    ...
    await t.test('"findChild" method tests...', async (t) => {
        await t.test('Should correctly find child node - case 1', () => {
            ...
            const tree = new GeneralTree();
            const parentNode = new GeneralTreeNode(tree, null, null, (data, treeNode) => data === treeNode.data ? COMPARATOR_EQUAL : COMPARATOR_NONE_EQUAL, data);
            const [ dataForTest ] = prepareDataForIterationTest(tree, parentNode, childData);
        ...
        await t.test('Should correctly find child node - case 2', () => {
            ...
            const tree = new GeneralTree();
            const parentNode = new GeneralTreeNode(tree, null, null, ([method, pathPart], childNode) => pathPartTreeComparator(childNode, method, pathPart), data);
            const [ dataForTest ] = prepareDataForIterationTest(tree, parentNode, childData);
