...
import BinarySearchTreeInOrderTraverseClass from './../../../../src/data_structures/binary_tree/traversal/binary_search_tree_in_order_traverse_class.js';

// implementation
test('BinarySearchTreeInOrderTraverseClass tests...', async (t) => {
    ...
    await t.test('Should traverse a tree - case 1', () => {
        ...
        BinarySearchTreeInOrderTraverseClass.traverse(treeInstance, (node) => traversedKeys.push(node.key));
